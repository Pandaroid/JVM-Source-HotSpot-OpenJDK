...
class WindbgCDebugInfoBuilder
            ...
            while (!iter.typeStringDone()) {
                switch (iter.typeStringLeaf()) {
                            ...
                            while (!fieldIter.typeStringDone()) {
                                ...
                                switch (fieldIter.typeStringLeaf()) {
                                    ...
                                    case LF_PAD15:
                                        break;
                                    default:
                                        System.err.println("WARNING: unexpected leaf index " +
                    ...
                    case LF_LABEL:
                        break;
                    case LF_NULL:
                        break; // FIXME: do we need to handle this? With what?
                    case LF_DIMARRAY:
                ...
                for (; !symIter.done(); symIter.next()) {
                    switch (symIter.getType()) {
                        case S_COMPILE:
                            break;
                        case S_SSEARCH:
                            break; // FIXME: may need this later
                        case S_END: {
                            try {
                        ...
                        case S_COBOLUDT:
                            break;
                        case S_MANYREG:
                            break; // FIXME: may need to add support for this
                        case S_RETURN:
                            break;  // NOTE: would need this if adding support for calling functions
                        case S_ENTRYTHIS:
                            break; // FIXME: may need to add support for this
                        case S_REGISTER:
                            break; // FIXME: may need to add support for this
                        case S_CONSTANT:
                            break; // FIXME: will need to add support for this
                        case S_UDT:
                            break; // FIXME: need to see how these are used; are
                        ...
                        case S_PUB32:
                            break; // FIXME: figure out how these differ from
                        ...
                        case S_CEXMODEL32:
                            break;
                        case S_VFTTABLE32:
                            break; // FIXME: may need to handle this
                        ...
                        case S_LTHREAD32:
                            break;
                        case S_GTHREAD32:
                            break;  // FIXME: may need to add support for these
                        case S_PROCREF:
                            break;
                        case S_DATAREF:
                            break;
                ...
                switch (primType) {
                    ...
                    case RESERVED_TYPE_UNSIGNED_INT: {
                        ...
                        switch (intIndex & RESERVED_SIZE_MASK) {
                            case RESERVED_SIZE_INT_1_BYTE:
                                size = 1;
                                name = "char";
                                break;
                            case RESERVED_SIZE_INT_2_BYTE:
                                size = 2;
                                name = "short";
                                break;
                            case RESERVED_SIZE_INT_4_BYTE:
                                size = 4;
                                name = "int";
                                break;
                            case RESERVED_SIZE_INT_8_BYTE:
                                size = 8;
                                name = "__int64";
                                break;
                            default:
                    ...
                    case RESERVED_TYPE_SPECIAL: {
                        switch (intIndex & RESERVED_SIZE_MASK) {
                            ...
                            case RESERVED_SIZE_SPECIAL_VOID:
    ...
    private int memberAttributeToAccessControl(short memberAttribute) {
        ...
        switch (acc) {
            case MEMATTR_ACCESS_NO_PROTECTION:
                return NO_PROTECTION;
            case MEMATTR_ACCESS_PRIVATE:
                return PRIVATE;
            case MEMATTR_ACCESS_PROTECTED:
                return PROTECTED;
            case MEMATTR_ACCESS_PUBLIC:
                return PUBLIC;
            default:
