...
public class BytecodeTableswitch extends Bytecode {
    ...
    public int defaultOffset() {
        return javaSignedWordAt(alignedOffset(1 + 0 * jintSize));
    }

    public int lowKey() {
        return javaSignedWordAt(alignedOffset(1 + 1 * jintSize));
    }

    public int highKey() {
        return javaSignedWordAt(alignedOffset(1 + 2 * jintSize));
    }
