...
public class BytecodeStream {
    ...
    public int getIndexU1() {
        return _method.getBytecodeOrBPAt(bci() + 1) & 0xFF;
    }

    public int getIndexU2() {
        return _method.getBytecodeShortArg(bci() + 1) & 0xFFFF;
    }

    public int getIndexU4() {
        return _method.getNativeIntArg(bci() + 1);
    }

    public boolean hasIndexU4() {
        return code() == Bytecodes._invokedynamic;
    }
    ...
    public int getIndexU2Cpcache() {
        return _method.getNativeShortArg(bci() + 1) & 0xFFFF;
    }
