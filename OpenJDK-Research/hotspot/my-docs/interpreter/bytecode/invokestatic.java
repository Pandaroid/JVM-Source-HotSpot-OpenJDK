invokestatic 184invokestatic[0x07f158f0,0x07f15a20]304bytes
        ...
        对应VS中的Intel汇编格式
        01F75914mov dword ptr[ebp-1Ch],esi
        01F75917movzx edx,word ptr[esi+1]
        01F7591B mov ecx,dword ptr[ebp-14h]
        01F7591Eshl edx,2
        01F75921mov ebx,dword ptr[ecx+edx*4+8]
        01F75925shr ebx,10h
        01F75928and ebx,0FFh
        01F7592Ecmp ebx,0B8h
        01F75934je 01F759E7
        01F7593A mov ebx,0B8h
        01F7593Fcall 01F75949
        01F75944jmp 01F759DD
        01F75949push ebx
        01F7594A lea eax,[esp+8]
        01F7594Ecmp dword ptr[ebp-8],0
        01F75955je 01F7596C
        01F7595B push 57CE0188h
        01F75960call 01F75965
        01F75965pushad
        01F75966call MacroAssembler::debug32(577BDBF0h)
        01F7596B hlt
        01F7596C mov dword ptr[ebp-1Ch],esi
        01F7596Fmov edi,dword ptr fs:[0]
        01F75977mov edi,dword ptr[edi-0Ch]
        01F7597A push edi
        01F7597B mov dword ptr[edi+144h],ebp
        01F75981mov dword ptr[edi+13Ch],eax
        01F75987call InterpreterRuntime::resolve_invoke(57A2B0B0h)
        01F7598C add esp,8
        01F7598Fpush eax
        01F75990mov eax,dword ptr fs:[0]
        01F75998mov eax,dword ptr[eax-0Ch]
        ...
        01F759D0jne 01F60340
        01F759D6mov esi,dword ptr[ebp-1Ch]
        01F759D9mov edi,dword ptr[ebp-18h]
        01F759DC ret
        01F759DD movzx edx,word ptr[esi+1]
        01F759E1mov ecx,dword ptr[ebp-14h]
        01F759E4shl edx,2
        01F759E7mov ebx,dword ptr[ecx+edx*4+0Ch]
        01F759EB mov edx,dword ptr[ecx+edx*4+14h]
        01F759EFshr edx,1Ch
        01F759F2mov edx,dword ptr[edx*4+57FF77CCh]
        01F759F9push edx
