invokeinterface 185invokeinterface[0x07f181b0,0x07f184f0]832bytes
        ...
        0x07f181d3:push%eax
        0x07f181d4:mov%esi,-0x1c(%ebp)
        0x07f181d7:movzwl 0x1(%esi),%edx
        0x07f181db:mov-0x14(%ebp),%ecx
        ...
        0x07f182a7:mov 0xc(%ecx,%edx,4),%eax
        0x07f182ab:mov 0x10(%ecx,%edx,4),%ebx
        0x07f182af:mov 0x14(%ecx,%edx,4),%edx
        0x07f182b3:mov%edx,%ecx
        0x07f182b5:and $0xff,%ecx
        0x07f182bb:mov-0x4(%esp,%ecx,4),%ecx
        0x07f182bf:mov%edx,%esi
        0x07f182c1:shr $0x1c,%edx
        0x07f182c4:mov 0x59595460(,%edx,4),%edx
        0x07f182cb:push%edx
        0x07f182cc:mov%esi,%edx
        0x07f182ce:mov-0x1c(%ebp),%esi
        0x07f182d1:mov%edx,%edi
        0x07f182d3:and $0x800000,%edi
        0x07f182d9:je 0x07f1830d
        0x07f182df:mov%edx,%eax
        0x07f182e1:and $0x100000,%eax
        ...
        0x07f1834e:lea 0x4(%esp),%esi
        0x07f18352:mov%esi,-0x8(%ebp)
