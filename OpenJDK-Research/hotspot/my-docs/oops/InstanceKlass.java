-_value 0x03b611d8{_annotations=0x00000000{_class_annotations=???_fields_annotations=???_class_type_annotations=...}...}Klass*
        ...
        -Klass{_layout_helper=8_super_check_offset=28_name=0x0032ca20{_body=0x0032ca28"java/lang/Object\xf"}...}Klass
        ...
        _valid 0int
        _layout_helper 8int
        _super_check_offset 28unsigned int
        ...
        +_secondary_supers 0x03b60958{_length=0_data=0x03b6095c{0x00000000{_layout_helper=???_super_check_offset=???_name=...}}}Array<Klass *>*
        +_primary_supers 0x03b611f4{0x03b611d8{_layout_helper=8_super_check_offset=28_name=0x0032ca20{_body=0x0032ca28"java/lang/Object\xf"}...},...}Klass*[8]
        ...
        _modifier_flags 1int
        +_access_flags{_flags=553648161}AccessFlags
        _last_biased_lock_bulk_revocation_time 0__int64
        +_prototype_header 0x00000001{...}markOopDesc*
        _biased_lock_revocation_count 0int
        ...
        +_constants 0x03b609c0{_tags=0x03b60968{_length=79_data=0x03b6096c""}_cache=0x00000000{_length=???_constant_pool=...}...}ConstantPool*
        +_inner_classes 0x03b60938{_length=0_data=0x03b6093c{0}}Array<unsigned short>*
        ...
        _nonstatic_field_size 0int
        _static_field_size 0int
        _generic_signature_index 0unsigned short
        _source_file_name_index 78unsigned short
        _static_oop_field_count 0unsigned short
        _java_fields_count 0unsigned short
        _nonstatic_oop_map_size 0int
        _is_marked_dependent false bool
        _misc_flags 0unsigned short
        _minor_version 0unsigned short
        _major_version 52unsigned short
...
+_member_names 0x00000000{...}MemberNameTable*
        ...
        _idnum_allocated_count 14volatile unsigned short
        ...
        _verify_count 0int
        +_methods 0x03b60b40{_length=14_data=0x03b60b44{0x03b60bb0{_constMethod=0x03b60b80{_fingerprint=9223372036854775808 ...}...}}}Array<Method *>*
        +_default_methods 0x00000000{_length=???_data=0x00000004{???}}Array<Method *>*
        +_local_interfaces 0x03b60958{_length=0_data=0x03b6095c{0x00000000{_layout_helper=???_super_check_offset=???_name=...}}}Array<Klass *>*
        +_transitive_interfaces 0x03b60958{_length=0_data=0x03b6095c{0x00000000{_layout_helper=???_super_check_offset=???_name=...}}}Array<Klass *>*
        +_method_ordering 0x03b60928{_length=0_data=0x03b6092c{0}}Array<int>*
        +_default_vtable_indices 0x00000000{_length=???_data=0x00000004{???}}Array<int>*
        +_fields 0x03b60b30{_length=0_data=0x03b60b34{0}}Array<unsigned short>*
...
*/
        ...
        header由下面字段组成:
        ==========
                Klass::instance_layout_helper returned 1int
        -this 0x048b0e28{_annotations=0x00000000{_class_annotations=???_fields_annotations=???_class_type_annotations=...}...}InstanceKlass*
        -Klass{_layout_helper=1_super_check_offset=28_name=0x00000000{_body=0x00000008<Error reading characters of string.>}...}Klass
        -Metadata{_valid=0}Metadata
        MetaspaceObj{...}MetaspaceObj
        ...
        +_primary_supers 0x048b0e44{0x048b0e28{_layout_helper=1_super_check_offset=28_name=0x00000000{_body=0x00000008<Error reading characters of string.>}...},...}Klass*[8]
        +_java_mirror 0x00000000{_mark=???_metadata={_klass=???_compressed_klass=???}}oopDesc*
        +_super 0x00000000{_layout_helper=???_super_check_offset=???_name=???...}Klass*
        +_subklass 0x00000000{_layout_helper=???_super_check_offset=???_name=???...}Klass*
        +_next_sibling 0x00000000{_layout_helper=???_super_check_offset=???_name=???...}Klass*
        ...
        _static_field_size 0int
        _generic_signature_index 0unsigned short
        _source_file_name_index 0unsigned short
        _static_oop_field_count 0unsigned short
        _java_fields_count 0unsigned short
        _nonstatic_oop_map_size 0int
        _is_marked_dependent false bool
        _misc_flags 0unsigned short
        _minor_version 0unsigned short
        _major_version 0unsigned short
        +_init_thread 0x00000000{_real_malloc_address=???_SR_lock=???_suspend_flags=???...}Thread*
        _vtable_len 5int
        _itable_len 2int
        +_oop_map_cache 0x00000000{_array=???_mut={...}}OopMapCache*volatile
+_member_names 0x00000000{...}MemberNameTable*
        ...
        +_previous_versions 0x00000000{_data=???}GrowableArray<PreviousVersionNode *>*
        +_cached_class_file 0x00000000{length=???data=0x00000004<Error reading characters of string.>}JvmtiCachedClassFileData*
        _idnum_allocated_count 0volatile unsigned short
        _init_state 0'\0' unsigned char
        _reference_type 0'\0' unsigned char
        +_jvmti_cached_class_field_map 0x00000000{_field_map=???}JvmtiCachedClassFieldMap*
        _verify_count 0int
