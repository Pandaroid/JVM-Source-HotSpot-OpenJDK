...
ConstMethod的内存布局:
        ...
        _fingerprint 9223372036854775808volatile unsigned __int64
        +_constants 0x00000000ConstantPool*
        +_stackmap_data 0x00000000Array<unsigned char>*
        _constMethod_size 12int
        _flags 1unsigned short
        _code_size 1unsigned short
        _name_index 0unsigned short
        _signature_index 0unsigned short
        _method_idnum 0unsigned short
        _max_stack 0unsigned short
        _max_locals 0unsigned short
        _size_of_parameters 0unsigned short
