...
struct JavaPermission{
        ...
        调用栈:
        --------------------------------
        >jvm.dll!HelpDCmd::execute(DCmdSource source,Thread*__the_thread__)Line 83C++
        jvm.dll!DCmd::parse_and_execute(DCmdSource source,outputStream*out,const char*cmdline,char delim,Thread*__the_thread__)Line 403C++
        jvm.dll!jcmd(AttachOperation*op,outputStream*out)Line 160C++
        jvm.dll!attach_listener_thread_entry(JavaThread*thread,Thread*__the_thread__)Line 442C++
        jvm.dll!JavaThread::thread_main_inner()Line 1699C++
        jvm.dll!JavaThread::run()Line 1682C++
