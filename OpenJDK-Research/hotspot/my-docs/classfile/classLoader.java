share\vm\classfile\classLoader.hpp
        ...
        Call Stack
        jvm.dll!ClassLoader::initialize()Line 965C++
        jvm.dll!classLoader_init()Line 1078C++
        jvm.dll!init_globals()Line 98C++
        jvm.dll!Threads::create_vm(JavaVMInitArgs*args,bool*canTryAgain)Line 3424C++
