...
static Symbol*java_lang_Byte_ByteCache(){
        return _symbols[java_lang_Byte_ByteCache_enum];
        }
...
static Symbol*java_lang_reflect_Parameter(){
        return _symbols[java_lang_reflect_Parameter_enum];
        }
...
static Symbol*java_lang_SecurityManager(){
        return _symbols[java_lang_SecurityManager_enum];
        }
...
static Symbol*sun_misc_Launcher_ExtClassLoader(){
        return _symbols[sun_misc_Launcher_ExtClassLoader_enum];
        }

/* Java runtime version access */
static Symbol*sun_misc_Version(){
        return _symbols[sun_misc_Version_enum];
        }
static Symbol*java_runtime_name_name(){
        return _symbols[java_runtime_name_name_enum];
        }
static Symbol*java_runtime_version_name(){
        return _symbols[java_runtime_version_name_enum];
        }
...
static Symbol*tag_method_parameters(){
        return _symbols[tag_method_parameters_enum];
        }
...
static Symbol*tag_runtime_visible_type_annotations(){
        return _symbols[tag_runtime_visible_type_annotations_enum];
        }
static Symbol*tag_runtime_invisible_type_annotations(){
        return _symbols[tag_runtime_invisible_type_annotations_enum];
        }
...
static Symbol*java_lang_StringIndexOutOfBoundsException(){
        ...
        }static Symbol*java_lang_UnsupportedOperationException(){
        return _symbols[java_lang_UnsupportedOperationException_enum];
        }
...
static Symbol*sun_misc_Contended_signature(){
        return _symbols[sun_misc_Contended_signature_enum];
        }
...
static Symbol*sun_nio_cs_iso8859_1_Encoder(){
        return _symbols[sun_nio_cs_iso8859_1_Encoder_enum];
        }
...
static Symbol*com_sun_crypto_provider_aescrypt(){
        return _symbols[com_sun_crypto_provider_aescrypt_enum];
        }


static Symbol*com_sun_crypto_provider_cipherBlockChaining(){
        return _symbols[com_sun_crypto_provider_cipherBlockChaining_enum];
        }
...
static Symbol*java_util_zip_CRC32(){
        return _symbols[java_util_zip_CRC32_enum];
        }
...
static Symbol*sun_reflect_CallerSensitive(){
        return _symbols[sun_reflect_CallerSensitive_enum];
        }
static Symbol*sun_reflect_CallerSensitive_signature(){
        return _symbols[sun_reflect_CallerSensitive_signature_enum];
        }
...
static Symbol*invokeBasic_name(){
        return _symbols[invokeBasic_name_enum];
        }
static Symbol*linkToVirtual_name(){
        return _symbols[linkToVirtual_name_enum];
        }
static Symbol*linkToStatic_name(){
        return _symbols[linkToStatic_name_enum];
        }
static Symbol*linkToSpecial_name(){
        return _symbols[linkToSpecial_name_enum];
        }
static Symbol*linkToInterface_name(){
        return _symbols[linkToInterface_name_enum];
        }
static Symbol*compiledLambdaForm_name(){
        return _symbols[compiledLambdaForm_name_enum];
        }  /*fake name*/
...
static Symbol*index_name(){
        return _symbols[index_name_enum];
        }
static Symbol*executable_name(){
        return _symbols[executable_name_enum];
        }
...
static Symbol*ConstantPool_name(){
        return _symbols[ConstantPool_name_enum];
        }
...
static Symbol*type_annotations_name(){
        return _symbols[type_annotations_name_enum];
        }
...
static Symbol*java_lang_invoke_MemberName_signature(){
        return _symbols[java_lang_invoke_MemberName_signature_enum];
        }
static Symbol*java_lang_invoke_LambdaForm_signature(){
        return _symbols[java_lang_invoke_LambdaForm_signature_enum];
        }
...
static Symbol*java_lang_invoke_LambdaForm(){
        return _symbols[java_lang_invoke_LambdaForm_enum];
        }
static Symbol*java_lang_invoke_ForceInline_signature(){
        return _symbols[java_lang_invoke_ForceInline_signature_enum];
        }
static Symbol*java_lang_invoke_DontInline_signature(){
        return _symbols[java_lang_invoke_DontInline_signature_enum];
        }
static Symbol*java_lang_invoke_Stable_signature(){
        return _symbols[java_lang_invoke_Stable_signature_enum];
        }
static Symbol*java_lang_invoke_LambdaForm_Compiled_signature(){
        return _symbols[java_lang_invoke_LambdaForm_Compiled_signature_enum];
        }
static Symbol*java_lang_invoke_LambdaForm_Hidden_signature(){
        return _symbols[java_lang_invoke_LambdaForm_Hidden_signature_enum];
        }
...
static Symbol*linkMethod_name(){
        return _symbols[linkMethod_name_enum];
        }
static Symbol*linkMethod_signature(){
        return _symbols[linkMethod_signature_enum];
        }
static Symbol*linkCallSite_name(){
        return _symbols[linkCallSite_name_enum];
        }
static Symbol*linkCallSite_signature(){
        return _symbols[linkCallSite_signature_enum];
        }
...
static Symbol*throwIllegalAccessError_name(){
        return _symbols[throwIllegalAccessError_name_enum];
        }
...
static Symbol*getClassContext_name(){
        return _symbols[getClassContext_name_enum];
        }
...
static Symbol*member_name(){
        return _symbols[member_name_enum];
        }
...
static Symbol*next_target_name(){
        return _symbols[next_target_name_enum];
        }
static Symbol*vmloader_name(){
        return _symbols[vmloader_name_enum];
        }
...
static Symbol*basicType_name(){
        return _symbols[basicType_name_enum];
        }
...
static Symbol*protection_domain_name(){
        return _symbols[protection_domain_name_enum];
        }
static Symbol*init_lock_name(){
        return _symbols[init_lock_name_enum];
        }
static Symbol*signers_name(){
        return _symbols[signers_name_enum];
        }
static Symbol*loader_data_name(){
        return _symbols[loader_data_name_enum];
        }
static Symbol*dependencies_name(){
        return _symbols[dependencies_name_enum];
        }
...
static Symbol*addExact_name(){
        return _symbols[addExact_name_enum];
        }
static Symbol*decrementExact_name(){
        return _symbols[decrementExact_name_enum];
        }
static Symbol*incrementExact_name(){
        return _symbols[incrementExact_name_enum];
        }
static Symbol*multiplyExact_name(){
        return _symbols[multiplyExact_name_enum];
        }
static Symbol*negateExact_name(){
        return _symbols[negateExact_name_enum];
        }
static Symbol*subtractExact_name(){
        return _symbols[subtractExact_name_enum];
        }
...
static Symbol*encodeISOArray_name(){
        return _symbols[encodeISOArray_name_enum];
        }
...
static Symbol*encryptBlock_name(){
        return _symbols[encryptBlock_name_enum];
        }
static Symbol*decryptBlock_name(){
        return _symbols[decryptBlock_name_enum];
        }


static Symbol*encrypt_name(){
        return _symbols[encrypt_name_enum];
        }
static Symbol*decrypt_name(){
        return _symbols[decrypt_name_enum];
        }
...
static Symbol*update_name(){
        return _symbols[update_name_enum];
        }

static Symbol*updateBytes_name(){
        return _symbols[updateBytes_name_enum];
        }


static Symbol*updateByteBuffer_name(){
        return _symbols[updateByteBuffer_name_enum];
        }
...
static Symbol*loadFence_name(){
        return _symbols[loadFence_name_enum];
        }


static Symbol*storeFence_name(){
        return _symbols[storeFence_name_enum];
        }


static Symbol*fullFence_name(){
        return _symbols[fullFence_name_enum];
        }
...
static Symbol*getAndAddInt_name(){
        return _symbols[getAndAddInt_name_enum];
        }


static Symbol*getAndAddLong_name(){
        return _symbols[getAndAddLong_name_enum];
        }


static Symbol*getAndSetInt_name(){
        return _symbols[getAndSetInt_name_enum];
        }


static Symbol*getAndSetLong_name(){
        return _symbols[getAndSetLong_name_enum];
        }

static Symbol*getAndSetObject_name(){
        return _symbols[getAndSetObject_name_enum];
        }
...
static Symbol*class_long_signature(){
        return _symbols[class_long_signature_enum];
        }
...
static Symbol*void_class_array_signature(){
        return _symbols[void_class_array_signature_enum];
        }
...
static Symbol*executable_signature(){
        return _symbols[executable_signature_enum];
        }
...
static Symbol*long2_long_signature(){
        return _symbols[long2_long_signature_enum];
        }
...
static Symbol*encodeISOArray_signature(){
        return _symbols[encodeISOArray_signature_enum];
        }
...
static Symbol*byteArray_int_byteArray_int_signature(){
        return _symbols[byteArray_int_byteArray_int_signature_enum];
        }


static Symbol*byteArray_int_int_byteArray_int_signature(){
        return _symbols[byteArray_int_int_byteArray_int_signature_enum];
        }
...
static Symbol*updateBytes_signature(){
        return _symbols[updateBytes_signature_enum];
        }


static Symbol*updateByteBuffer_signature(){
        return _symbols[updateByteBuffer_signature_enum];
        }
...
static Symbol*getAndAddInt_signature(){
        return _symbols[getAndAddInt_signature_enum];
        }


static Symbol*getAndAddLong_signature(){
        return _symbols[getAndAddLong_signature_enum];
        }


static Symbol*getAndSetObject_signature(){
        return _symbols[getAndSetObject_signature_enum];
        }
...
static Symbol*loadFence_signature(){
        return _symbols[loadFence_signature_enum];
        }


static Symbol*storeFence_signature(){
        return _symbols[storeFence_signature_enum];
        }


static Symbol*fullFence_signature(){
        return _symbols[fullFence_signature_enum];
        }
...
static Symbol*getAndSetInt_signature(){
        return _symbols[getAndSetInt_signature_enum];
        }


static Symbol*getAndSetLong_signature(){
        return _symbols[getAndSetLong_signature_enum];
        }
...
static Symbol*sun_management_DiagnosticCommandImpl(){
        return _symbols[sun_management_DiagnosticCommandImpl_enum];
        }
static Symbol*sun_management_GarbageCollectorImpl(){
        return _symbols[sun_management_GarbageCollectorImpl_enum];
        }
static Symbol*sun_management_ManagementFactoryHelper(){
        return _symbols[sun_management_ManagementFactoryHelper_enum];
        }
static Symbol*getDiagnosticCommandMBean_name(){
        return _symbols[getDiagnosticCommandMBean_name_enum];
        }
static Symbol*getDiagnosticCommandMBean_signature(){
        return _symbols[getDiagnosticCommandMBean_signature_enum];
        }
...
static Symbol*createDiagnosticFrameworkNotification_name(){
        return _symbols[createDiagnosticFrameworkNotification_name_enum];
        }
