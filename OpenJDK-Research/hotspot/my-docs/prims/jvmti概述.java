JAVA_TOOL_OPTIONS
        ...
        -------------------------------
        myagent.dll!Agent_OnLoad(const JNIInvokeInterface_**vm,char*options,void*reserved)Line 101C
        jvm.dll!Threads::create_vm_init_agents()Line 3825C++
        jvm.dll!Threads::create_vm(JavaVMInitArgs*args,bool*canTryAgain)Line 3385C++
        jvm.dll!JNI_CreateJavaVM(JavaVM_**vm,void**penv,void*args)Line 5166C++
