...
public class PolynomialRoot {
    ...
    public static int root4(final double[] p, final double[] re_root, final double[] im_root) {
        ...
        if (PRINT_DEBUG)
            System.err.println("aa=" + aa + " pp=" + pp + " qq=" + qq + " rr=" + rr + " rc=" + rc + " sc=" + sc + " tc=" + tc);
         ...
         * u[1] and u[2], respectively. */
        {
            ...
            if (PRINT_DEBUG)
                System.err.println("u[0]=" + u[0] + " u[1]=" + u[1] + " u[2]=" + u[2] + " qq=" + qq + " disc=" + ((CR2 - CQ3) / 2125764.0));
        }
        ...
        if (flag_realroots) {
            ...
            if (PRINT_DEBUG)
                System.err.println("u[0]=" + u[0] + "u[1]=" + u[1] + " u[2]=" + u[2] + " absu0=" + absu0 + " w_mod=" + w_mod + " w_mod2=" + w_mod2);
        }
        ...
        final double h = r4 * a;
        if (PRINT_DEBUG)
            System.err.println("w1_re=" + w1_re + " w1_im=" + w1_im + " w2_re=" + w2_re + " w2_im=" + w2_im + " w3_re=" + w3_re + " w3_im=" + w3_im + " h=" + h);
