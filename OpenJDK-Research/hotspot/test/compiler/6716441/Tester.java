...
final class Tester_Class_2 extends Tester_Class_0 {
    ...
    public String toString() {
        String result = "[\n";
        result += "Tester_Class_2.var_13 = ";
        result += Tester.Printer.print(var_13);
        result += "\n";
        result += "Tester_Class_2.var_14 = ";
...
public class Tester {
    ...
    public String toString() {
        String result = "[\n";
        result += "Tester.var_29 = ";
        result += Printer.print(var_29);
        result += "\n";
        result += "Tester.var_30 = ";
        result += Printer.print(var_30);
        result += "\n";
        result += "Tester.var_32 = ";
        result += Printer.print(var_32);
        result += "\n";
        result += "Tester.var_31 = ";
        result += Printer.print(var_31);
        result += "\n";
        result += "Tester.var_28 = ";
        result += Printer.print(var_28);
        result += "";
        result += "\n]";
        return result;
    }
