...
final class Tester_Class_1 extends Tester_Class_0 {
    ...
    public String toString() {
        ...
        result += Tester.Printer.print(var_1);
        result += "\n";
        result += "Tester_Class_1.var_16 = ";
        result += Tester.Printer.print(var_16);
        result += "\n";
        result += "Tester_Class_1.var_20 = ";
        result += Tester.Printer.print(var_20);
        result += "\n";
        result += "Tester_Class_1.var_21 = ";
        result += Tester.Printer.print(var_21);
        result += "\n";
        result += "Tester_Class_1.var_14 = ";
        result += Tester.Printer.print(var_14);
        result += "\n";
        result += "Tester_Class_1.var_18 = ";
        result += Tester.Printer.print(var_18);
        result += "\n";
        result += "Tester_Class_1.var_17 = ";
        result += Tester.Printer.print(var_17);
        result += "\n";
        result += "Tester_Class_1.var_19 = ";
        result += Tester.Printer.print(var_19);
        result += "\n";
        result += "Tester_Class_1.var_22 = ";
        result += Tester.Printer.print(var_22);
        result += "\n";
        result += "Tester_Class_1.var_13 = ";
        result += Tester.Printer.print(var_13);
        result += "\n";
        result += "Tester_Class_1.var_15 = ";
        result += Tester.Printer.print(var_15);
        result += "";
        result += "\n]";
        return result;
    }
...
class Tester_Class_2 extends Tester_Class_0 {
    ...
    public String toString() {
        String result = "[\n";
        result += "Tester_Class_2.var_43 = ";
        result += Tester.Printer.print(var_43);
        result += "\n";
        result += "Tester_Class_2.var_48 = ";
        result += Tester.Printer.print(var_48);
        result += "\n";
        result += "Tester_Class_2.var_44 = ";
        result += Tester.Printer.print(var_44);
        result += "\n";
        result += "Tester_Class_2.var_46 = ";
        result += Tester.Printer.print(var_46);
        result += "\n";
        result += "Tester_Class_2.var_47 = ";
        result += Tester.Printer.print(var_47);
        result += "\n";
        result += "Tester_Class_2.var_1 = ";
        result += Tester.Printer.print(var_1);
        result += "\n";
        result += "Tester_Class_2.var_45 = ";
        result += Tester.Printer.print(var_45);
        result += "";
        result += "\n]";
        return result;
    }
...
class Tester_Class_3 extends Tester_Class_0 {
    ...
    public String toString() {
        String result = "[\n";
        result += "Tester_Class_3.var_51 = ";
        result += Tester.Printer.print(var_51);
        result += "\n";
        result += "Tester_Class_3.var_54 = ";
        result += Tester.Printer.print(var_54);
        result += "\n";
        result += "Tester_Class_3.var_52 = ";
        result += Tester.Printer.print(var_52);
        result += "\n";
        result += "Tester_Class_3.var_55 = ";
        result += Tester.Printer.print(var_55);
        result += "\n";
        result += "Tester_Class_3.var_56 = ";
        result += Tester.Printer.print(var_56);
        result += "\n";
        result += "Tester_Class_3.var_1 = ";
        result += Tester.Printer.print(var_1);
        result += "\n";
        result += "Tester_Class_3.var_50 = ";
        result += Tester.Printer.print(var_50);
        result += "\n";
        result += "Tester_Class_3.var_53 = ";
        result += Tester.Printer.print(var_53);
        result += "";
        result += "\n]";
        return result;
    }
...
public class Tester {
    ...
    public String toString() {
        String result = "[\n";
        result += "Tester.var_71 = ";
        result += Printer.print(var_71);
        result += "\n";
        result += "Tester.var_70 = ";
        result += Printer.print(var_70);
        result += "\n";
        result += "Tester.var_72 = ";
        result += Printer.print(var_72);
        result += "\n";
        result += "Tester.var_75 = ";
        result += Printer.print(var_75);
        result += "\n";
        result += "Tester.var_73 = ";
        result += Printer.print(var_73);
        result += "\n";
        result += "Tester.var_74 = ";
        result += Printer.print(var_74);
        result += "";
        result += "\n]";
        return result;
    }
