...
class s {
    ...
    static int modi(int dividend, int divisor) {
        return dividend % divisor;
    }

    static long divl(long dividend, long divisor) {
        return dividend / divisor;
    }

    static long modl(long dividend, long divisor) {
        return dividend % divisor;
    }
}
...
public class Test implements Runnable {
    ...
    public int divbyI(int dividend) {
        return dividend / DIVISOR;
    }

    public int modbyI(int dividend) {
        return dividend % DIVISOR;
    }

    public long divbyL(long dividend) {
        return dividend / DIVISOR;
    }

    public long modbyL(long dividend) {
        return dividend % DIVISOR;
    }
