...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  Each of the elements should be freed with </xsl:text>
    ...
    <xsl:template
            match="jmethodID|jfieldID|jframeID|jrawMonitorID|jclass|jobject|jvalue|jthreadGroup|enum|jint|jchar|jlong|jfloat|jdouble|jlocation|jboolean|char|uchar|size_t|void|varargs|struct"
            mode="funcdescription">
    </xsl:template>
    ...
    <xsl:template
            match="jmethodID|jfieldID|jframeID|jrawMonitorID|enum|jint|jchar|jlong|jfloat|jdouble|jlocation|jboolean|char|uchar|size_t|void|varargs"
            mode="returndescription">
    </xsl:template>
    ...
    <xsl:template
            match="ptrtype|vmbuf|jmethodID|jfieldID|jframeID|jrawMonitorID|enum|jint|jchar|jlong|jfloat|jdouble|jlocation|jboolean|char|uchar|size_t|void"
    ...
    <xsl:template
            match="jmethodID|jfieldID|jrawMonitorID|jclass|jthread|jobject|jvalue|jthreadGroup|jint|jchar|jlong|jfloat|jdouble|jlocation|jboolean|char|size_t|void"
            mode="signature">
    ...
    <xsl:template
            match="jmethodID|jfieldID|jrawMonitorID|jclass|jthread|jobject|jvalue|jint|jchar|jlong|jfloat|jdouble|jlocation|jboolean|jthreadGroup"
            mode="link">
        <a>
    ...
    <xsl:template
            match="jmethodID|jfieldID|jframeID|jrawMonitorID|jclass|jobject|jvalue|jthreadGroup|jthread|jint|jchar|jlong|jfloat|jdouble|jlocation|jboolean|char|size_t|void"
            mode="btsig">
        <xsl:value-of select="name()"/>
    </xsl:template>
...
typedef </xsl:text>
  ...
  <xsl:text>enum {
    ...
    <xsl:template
            match="jobject|jvalue|jthreadGroup|enum|jint|jchar|jlong|jfloat|jdouble|jlocation|jboolean|char|uchar|size_t|void|struct"
            mode="HotSpotType">
    ...
    <xsl:template
            match="jobject|jvalue|jthreadGroup|enum|jint|jchar|jlong|jfloat|jdouble|jlocation|jboolean|char|uchar|size_t|void|varargs|struct|outptr|outbuf|allocfieldbuf|ptrtype|inptr|inbuf|vmbuf|allocbuf|agentbuf|allocallocbuf"
            mode="HotSpotName">
        <xsl:param name="name"/>
        <xsl:value-of select="$name"/>
    </xsl:template>
    ...
    <xsl:template
            match="jobject|jvalue|jthreadGroup|enum|jint|jchar|jlong|jfloat|jdouble|jlocation|jboolean|char|uchar|size_t|void|struct|outptr|outbuf|allocfieldbuf|ptrtype|inptr|inbuf|vmbuf|allocbuf|agentbuf|allocallocbuf"
            mode="HotSpotValue">
        <xsl:param name="name"/>
        <xsl:value-of select="$name"/>
    </xsl:template>
